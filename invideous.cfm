		...
		<td align=center>
			...
			<cfelse>
				<cfif Flash is 2>
					...
					<script type="text/javascript" src="http://invideous.s3.amazonaws.com/html5/3.0.0/eversport/scripts/invideous.js"></script> 
					...
					OO.ready(function() { 
					OO.Player.create('ooyalaplayer', '<cfoutput>#ec#</cfoutput>',
					{ onCreate: invideous.ovps.ooyala.onCreate, wmode: 'transparent', autoplay: true }
					);
					});
					</script>
					<noscript><div>Please enable Javascript to watch this video</div></noscript>
